...
internal static class ThemePalette
{
    ...
    private static Dictionary<object, string> Dark() => new Dictionary<object, string>
    {
        ...
        [VsBrushes.ToolWindowButtonActiveGlyphKey] = "#F1F3F5",
        [VsBrushes.ToolWindowButtonHoverActiveKey] = "#333842",
        [VsBrushes.ToolWindowButtonHoverActiveGlyphKey] = "#FFFFFF",
        [VsBrushes.ToolWindowButtonHoverActiveBorderKey] = "#59616E",
        [VsBrushes.ToolWindowButtonDownKey] = "#3D4653",
        [VsBrushes.ToolWindowButtonDownActiveGlyphKey] = "#FFFFFF",
        [VsBrushes.ToolWindowButtonDownBorderKey] = "#718096",
        [VsBrushes.ToolWindowButtonInactiveKey] = "#00181A1F",
        [VsBrushes.ToolWindowButtonInactiveGlyphKey] = "#707782",
        [VsBrushes.ToolWindowButtonInactiveBorderKey] = "#00181A1F",
        ...
        [VsBrushes.CommandBarSelectedBorderKey] = "#4E9BD3",
        [VsBrushes.CommandBarHoverKey] = "#333842",
        [VsBrushes.CommandBarTextActiveKey] = "#F1F3F5",
        [VsBrushes.CommandBarTextHoverKey] = "#FFFFFF",
        [VsBrushes.CommandBarTextSelectedKey] = "#FFFFFF",
        [VsBrushes.ButtonFaceKey] = "#252932",
        [VsBrushes.ButtonShadowKey] = "#414650",
        [VsBrushes.GrayTextKey] = "#707782",
    ...
    private static Dictionary<object, string> Light() => new Dictionary<object, string>
    {
        ...
        [VsBrushes.ToolWindowButtonActiveGlyphKey] = "#1F242B",
        [VsBrushes.ToolWindowButtonHoverActiveKey] = "#E5EAF0",
        [VsBrushes.ToolWindowButtonHoverActiveGlyphKey] = "#111827",
        [VsBrushes.ToolWindowButtonHoverActiveBorderKey] = "#9CA7B3",
        [VsBrushes.ToolWindowButtonDownKey] = "#D9E2EA",
        [VsBrushes.ToolWindowButtonDownActiveGlyphKey] = "#0F172A",
        [VsBrushes.ToolWindowButtonDownBorderKey] = "#7D8A98",
        [VsBrushes.ToolWindowButtonInactiveKey] = "#00F7F8FA",
        [VsBrushes.ToolWindowButtonInactiveGlyphKey] = "#A1A7AF",
        [VsBrushes.ToolWindowButtonInactiveBorderKey] = "#00F7F8FA",
        ...
        [VsBrushes.CommandBarSelectedBorderKey] = "#7CB7DF",
        [VsBrushes.CommandBarHoverKey] = "#E5EAF0",
        [VsBrushes.CommandBarTextActiveKey] = "#1F242B",
        [VsBrushes.CommandBarTextHoverKey] = "#111827",
        [VsBrushes.CommandBarTextSelectedKey] = "#0F4C75",
        [VsBrushes.ButtonFaceKey] = "#F0F1F3",
        [VsBrushes.ButtonShadowKey] = "#CBD0D7",
        [VsBrushes.GrayTextKey] = "#A1A7AF",
